...
# split -b 50000000  home_vcap_app_fakechroot-merged.tar.gz "home_vcap_app_fakechroot.tar.gz.part"
tar -zcf - ./app | split -b 50000000 - "home_vcap_app_fakechroot.tar.gz.part"
